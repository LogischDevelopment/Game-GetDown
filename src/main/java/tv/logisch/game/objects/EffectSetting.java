...
public class EffectSetting {
    ...
    public static final List<GameEffect> effects = List.of(
            ...
            new GameEffect(PotionEffectType.REGENERATION, 5, 2, true, true),
            new GameEffect(PotionEffectType.SLOW_FALLING, 10, 1, true, true),
            new GameEffect(PotionEffectType.JUMP_BOOST, 6, 3, true, true),
            new GameEffect(PotionEffectType.RESISTANCE, 4, 1, true, true),
            new GameEffect(PotionEffectType.ABSORPTION,  16, 4, true, true),
            new GameEffect(PotionEffectType.POISON, 7, 1, false, true),
            new GameEffect(PotionEffectType.WITHER, 3, 1, false, true),
            ...
            new GameEffect(PotionEffectType.NAUSEA, 10, 1, false, true)
    );
