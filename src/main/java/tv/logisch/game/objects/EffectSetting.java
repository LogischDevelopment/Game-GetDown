...
public class EffectSetting {
    ...
    public static final List<GameEffect> effects = List.of(
            ...
            new GameEffect(PotionEffectType.SLOW_FALLING, 5, 1, true, true),
            new GameEffect(PotionEffectType.JUMP_BOOST, 8, 1, true, true),
            new GameEffect(PotionEffectType.RESISTANCE, 8, 1, true, true),
            new GameEffect(PotionEffectType.ABSORPTION,  6, 2, true, true),
            new GameEffect(PotionEffectType.POISON, 6, 1, false, true),
            new GameEffect(PotionEffectType.WITHER, 6, 1, false, true),
